          ...
          <div className="student__content">
            ...
            <div className="student__about">
              ...
              <p className="student__bio">
                ...
                Радиотехнический факультет Полоцкого Государственного
                Университета по специальности "Проектирование и производство
                ...
                2020 года стал студентом в Яндекс.Практикум, после окончания
                учебы планирую сменить место работы, чтобы совершенствовать
                полученные навыки.
              </p>
